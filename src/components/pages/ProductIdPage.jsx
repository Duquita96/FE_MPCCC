    ...
    <div>
      <PageWrapper>
        ...
        <div id='product_description'>
          ...
          <div id='buy_section'>
            <div>
              <RiPaypalFill id='paypalIcon' className='buyIcon' color='gray' />
            </div>
            <div>
              <RiVisaFill id='visaIcon' className='buyIcon' color='gray' />
            </div>
            <div>
              <RiMastercardLine
                id='masterIcon'
            ...
            <div>
              <RiBankFill id='bankIcon' className='buyIcon' color='gray' />
            </div>
            <div>
              <RiCalendarScheduleFill
